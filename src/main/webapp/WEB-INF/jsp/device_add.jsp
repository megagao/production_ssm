	...
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        <tr>
	            <td>订购客户:</td>
	            <td>
	            	<input id="custom" class="easyui-combobox" name="custom"   
	        ...
	        <tr>
	            <td>订购产品:</td>
	            <td>
	            	<input id="product" class="easyui-combobox" name="product"   
	        ...
	        <tr>
	            ...
	            <td><input class="easyui-datetimebox" name="orderDate"     
        			data-options="required:true,showSeconds:false" value="5/5/2016 2:3" style="width:150px"> </td>
	        </tr>
	        <tr>
	            <td>要求日期:</td>
	        ...
	        <tr>
	            <td>商品描述:</td>
	            <td>
	                <textarea style="width:800px;height:300px;visibility:hidden;" name="file"></textarea>
	            </td>
	        </tr>
	    </table>
...
<script type="text/javascript">
	...
	$(function(){
		...
		itemAddEditor = KindEditor.create("#itemAddForm [name=file]", TT.kingEditorParams);
		//初始化类目选择和图片上传器
