...
<div id="noteDialog" class="easyui-dialog" title="备注" data-options="modal:false,closed:true,resizable:true,iconCls:'icon-save'" style="width:65%;height:80%;padding:10px;display: none">
