...
public class DeviceMaintainController {
	...
	private CustomResult insert(DeviceMaintain deviceMaintain) throws Exception {
		CustomResult result = deviceMaintainService.insert(deviceMaintain);
		return result;
	}
	
	@RequestMapping(value="/delete")
	@ResponseBody
	private CustomResult delete(String deviceMaintainId) throws Exception {
		CustomResult result = deviceMaintainService.delete(deviceMaintainId);
		return result;
	}
